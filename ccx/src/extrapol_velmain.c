...
static double *xrlfa1,*vfap1,*vel1,*c1,*xbounact1,*xxn1,*area1,*volume1,
    *gradvel1,*gradvfa1,*xxi1,*vfa1,*rf1,*xle1,*xlet1,*xxj1,*xxna1;
...
void extrapol_velmain(ITG *nface,ITG *ielfa,double *xrlfa,double *vel,
  ...
  xxn1=xxn;nef1=nef;num_cpus1=num_cpus;nface1=nface;ncfd1=ncfd;
  ...
  gradvel1=gradvel;nef1=nef;ncfd1=ncfd;
  ...
  gradvel1=gradvel;c1=c;ipnei1=ipnei;xxi1=xxi;nface1=nface;ncfd1=ncfd;
...
void *extrapol_vel1mt(ITG *i){
  ...
  FORTRAN(extrapol_vel1,(ielfa1,xrlfa1,icyclic1,ifatie1,vfap1,vel1,
			 c1,ifabou1,xbounact1,ipnei1,xxn1,nef1,
			 &nfacea,&nfaceb,ncfd1));
...
void *extrapol_vel2mt(ITG *i){
  ...
  FORTRAN(extrapol_vel2,(ipnei1,neifa1,vfa1,area1,xxna1,volume1,gradvel1,
			 &nefa,&nefb,ncfd1));
...
void *extrapol_vel3mt(ITG *i){
  ...
  FORTRAN(extrapol_vel3,(ielfa1,xrlfa1,icyclic1,ifatie1,gradvfa1,
			 gradvel1,c1,ipnei1,xxi1,&nfacea,&nfaceb,ncfd1));
...
void *extrapol_vel4mt(ITG *i){
  ...
  FORTRAN(extrapol_vel4,(ielfa1,vfa1,vfap1,gradvfa1,rf1,ifabou1,
			 ipnei1,xxn1,vel1,xxi1,xle1,nef1,&nfacea,
			 &nfaceb,ncfd1));
