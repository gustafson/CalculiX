...
// next line is to be inserted in a similar way for all other paralell parts
    ...
    gradkfa1=gradkfa;xxi1=xxi;body1=body;volume1=volume;
    ...
    gradkel1=gradkel;gradoel1=gradoel;inlet1=inlet;sc1=sc;
...
// next line! -> all parallel sections
    ...
    FORTRAN(mafillkcomp,(nef1,ipnei1,neifa1,neiel1,vfa1,xxn1,area1,
			 ...
			 b1,vel1,umfa1,alet1,ale1,gradkfa1,xxi1,
