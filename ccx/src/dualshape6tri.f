...
!
      subroutine dualshape6tri(xi,et,xl,xsj,xs,shp,iflag)
!
...
!
      integer i,j,k,iflag
!
      real*8 shp(4,6),xs(3,2),xsi(2,3),xl(0:3,6),sh(3),xsj(3)
!
      real*8 xi,et
!
...
!
      shp(3,1)=2.d0*(0.5d0-xi-et)*(1.d0-xi-et)
      shp(3,2)=xi*(2.d0*xi-1.d0)
      shp(3,3)=et*(2.d0*et-1.d0)
...
!
      shp(4,1)=shp(3,1)+(shp(3,4)+shp(3,6))/12.d0
      shp(4,2)=shp(3,2)+(shp(3,4)+shp(3,5))/12.d0
      shp(4,3)=shp(3,3)+(shp(3,5)+shp(3,6))/12.d0
!
