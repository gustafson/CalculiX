!
      subroutine generatetet2(kontet,ifatet,ifreetet,bc,ifac,itetfa,
     &  ifreefa,planfa,ipofa,
...
!     identical to generatetet, except for the update of the ieln
!     database
!
      implicit none
!
...
!
      intent(in) nodes,cotet
!
      intent(inout) iedg,ifreeed,ipoeln,ieln,ifreeln,bc,ifatet,itetfa,
     &  ipofa,ifac,ifreefa,kontet,ifreetet,ipoeled,ieled,ifreele,
     &  ipoed,iedtet,planfa
!
