...
!
      subroutine frdtensorcomp(stn,iset,nkcoords,inum,m1,istartset,
...
!
      character*3 m1
!
      integer iset,nkcoords,inum(*),ngraph,nksegment,icomp(6),
     &  istartset(*),iendset(*),ialset(*),i,j,k,l,m,kal(2,6),ncomp
!
      real*8 stn(6,*)
!
...
!
      if(iset.eq.0) then
         do i=1,nkcoords
            ...
            write(7,101) m1,i,(stn(icomp(j),i),j=1,ncomp)
         enddo
      else
