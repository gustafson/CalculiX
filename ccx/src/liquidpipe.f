...
!     
          elseif(lakon(nelem)(4:5).eq.'VF') then
            numf=3  
            if(R2.ge.R1) then
              f=p1-p2+xkp
              df(1)=1
          ...
          elseif(lakon(nelem)(4:5).eq.'VS') then
...
!     
c            write(*,*) 'liquidpipe ',reynolds
c            write(*,*) 'liquidpipe ',zeta
...
!     
     ...
     &           zeta
!     
          elseif(lakon(nelem)(4:5).eq.'FR')then                  
            write(1,*)'             Element ',nelem,lakon(nelem)
