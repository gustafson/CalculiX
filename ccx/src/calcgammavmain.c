...
static double *vel1,*gradvel1,*gamma1,*xlet1,*xxj1,*betam1,
    *flux1;
...
void calcgammavmain(ITG *nface,ITG *ielfa,double *vel,double *gradvel,
    ...
    ielfa1=ielfa;vel1=vel;gradvel1=gradvel;gamma1=gamma;xlet1=xlet;
	...
	ithread[i]=i;
	pthread_create(&tid[i], NULL, (void *)calcgammav1mt, (void *)&ithread[i]);
    }
