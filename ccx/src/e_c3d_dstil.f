...
!
      subroutine e_c3d_dstil(co,kon,lakonl,p1,p2,omx,bodyfx,nbody,s,sm,
...
!
     ...
     &                              shptil2(2,jj))+xsj2(2)*
     &                              (xkl(n,3)*shptil2(1,jj)-xkl(n,1)*
     &                              shptil2(3,jj))+xsj2(3)*
     &                              (xkl(n,1)*shptil2(2,jj)-xkl(n,2)*
     &                              shptil2(1,jj)))
                         ...
                         do kk=1,3
                            do k=1,3
                               do l=1,3
                                  ...
                                  term=-weight*stre(kk,k)*shptil2(4,ii)*
     &                                 eknlsign*(xsj2(1)*
     &                                 (xkl(n,2)*shptil2(3,jj)-xkl(n,3)*
     &                                 shptil2(2,jj))+xsj2(2)*
     &                                 (xkl(n,3)*shptil2(1,jj)-xkl(n,1)*
...
!
c      if(nelem.eq.1) then
c         open(30,file='nelem1_dstil.dat',status='unknown')
