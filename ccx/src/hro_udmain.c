...
void hro_udmain(ITG *nface,ITG *ielfa,double *vel,ITG *ipnei,ITG *nef,
	...
	ithread[i]=i;
	pthread_create(&tid[i], NULL, (void *)hro_ud1mt, (void *)&ithread[i]);
    }
...
void *hro_ud1mt(ITG *i){
    ...
    FORTRAN(hro_ud,(ielfa1,vel1,ipnei1,nef1,flux1,vfa1,
			       &nfacea,&nfaceb));
