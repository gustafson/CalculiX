...
*     .. Executable Statements ..
*
C      GO TO ( 100, 100, 100, 400, 500, 600, 700, 800, 900, 1000,
C     $        1100 ) ISPEC
C      CHANGED COMPUTED GOTO: OBSOLETE
C
      ...
      ELSEIF(ISPEC.EQ.6) THEN
         GO TO 600
      ELSEIF(ISPEC.EQ.7) THEN
         GO TO 700
      ELSEIF(ISPEC.EQ.8) THEN
         GO TO 800
      ELSEIF(ISPEC.EQ.9) THEN
         GO TO 900
      ELSEIF(ISPEC.EQ.10) THEN
         GO TO 1000
      ELSEIF(ISPEC.EQ.11) THEN
         GO TO 1100
      ENDIF
*
