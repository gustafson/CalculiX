...
static double *xrlfa1,*vfap1,*vel1,*c1,*xbounact1,*xxn1,*area1,*volume1,
    *gradtel1,*gradtfa1,*xxi1,*vfa1,*rf1,*xle1,*xlet1,*xxj1,*xload1,*xxna1;
...
void extrapol_telmain(ITG *nface,ITG *ielfa,double *xrlfa,double *vel,
    ...
    gradtel1=gradtel;nef1=nef;ncfd1=ncfd;
    ...
    xload1=xload;nface1=nface;ncfd1=ncfd;
...
void *extrapol_tel2mt(ITG *i){
    ...
    FORTRAN(extrapol_tel2,(ipnei1,neifa1,vfa1,area1,xxna1,volume1,gradtel1,
			   &nefa,&nefb,ncfd1));
