...
static ITG *nface1,*ielfa1,*ipnei1,*nef1,*num_cpus1,*neij1;

static double *vel1,*flux1,*vfa1,*xxi1,*xle1,*gradtel1;

void hrt_udmain(ITG *nface,ITG *ielfa,double *vel,ITG *ipnei,ITG *nef,
    ...
    num_cpus1=num_cpus;nface1=nface;xxi1=xxi;xle1=xle;gradtel1=gradtel;
    neij1=neij;
	...
	ithread[i]=i;
	pthread_create(&tid[i], NULL, (void *)hrt_ud1mt, (void *)&ithread[i]);
    }
...
void *hrt_ud1mt(ITG *i){
    ...
    FORTRAN(hrt_ud,(ielfa1,vel1,ipnei1,nef1,flux1,vfa1,
		     &nfacea,&nfaceb,xxi1,xle1,gradtel1,neij1));
