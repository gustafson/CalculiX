...
void setpardou(double *var1,double var2,ITG isize,ITG num_cpus){

    /* set elements of double array var1 to scalar var2 */
    ...
    for(i=0; i<num_cpus; i++)  {
      ithread[i]=i;
      pthread_create(&tid[i], NULL, (void *)setpardoumt, (void *)&ithread[i]);
    }
