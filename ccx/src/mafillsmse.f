...
!
     ...
     &  ieigenfrequency,set,nset,sigmak)
!
      implicit none
!
      character*8 lakon(*)
...
!
     ...
     &  stiffonly(2),coriolis,idesloc,nset,kk,node2
!
     ...
     &  physcon(*),prop(*),xstate(nstate_,mi(1),*),sigmak,
...
!     
     ...
     &           ialelem,v,sigma,ieigenfrequency,set,nset,sigmak)
!     
