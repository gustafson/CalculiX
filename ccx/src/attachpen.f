...
!
     ...
     &  d1,d2,d3,d4,dist,xil,etl,xnormastface(3,8)
!
c      d1=0.25d0
c      d2=3.125d-2
c      d3=3.9063d-3
...
!
      do i=-1,1
        do j=-1,1
          xi(i,j)=i*d1
          et(i,j)=j*d1
          call distattachpen(xi(i,j),et(i,j),pneigh,pnode,a(i,j),p,
     &      ratio,nterms,xnormastface)
        enddo
      enddo     
!
...
!
              call distattachpen(xi(i,j),et(i,j),pneigh,
     &          pnode,a(i,j),p,ratio,nterms,xnormastface)
c              write(*,*) a(i,j)
            endif
          enddo
        enddo
...
c              write(*,*) a(i,j)
      ...
      enddo
!
      call distattachpen(xi(0,0),et(0,0),pneigh,pnode,a(0,0),p,
     &     ratio,nterms,xnormastface)
!
      do i=1,3
        pnode(i)=p(i)
