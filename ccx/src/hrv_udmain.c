...
static double *vel1,*flux1,*vfa1,*xxi1,*xle1,*gradvel1;
...
void hrv_udmain(ITG *nface,ITG *ielfa,double *vel,ITG *ipnei,ITG *nef,
    ...
    num_cpus1=num_cpus;nface1=nface;xxi1=xxi;xle1=xle;gradvel1=gradvel;
    neij1=neij;
	...
	ithread[i]=i;
	pthread_create(&tid[i], NULL, (void *)hrv_ud1mt, (void *)&ithread[i]);
    }
...
void *hrv_ud1mt(ITG *i){
    ...
    FORTRAN(hrv_ud,(ielfa1,vel1,ipnei1,nef1,flux1,vfa1,
		     &nfacea,&nfaceb,xxi1,xle1,gradvel1,neij1));
