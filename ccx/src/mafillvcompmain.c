...
static double *auv1,*adv1,*bv1,*vfa1,*xxn1,*area1,*vel1,
    ...
    *c1,*xxni1,*xxnj1,*gradvel1,*of21,*yy1,*umel1,*sc1;
...
void mafillvcompmain(ITG *nef,ITG *ipnei,ITG *neifa,ITG *neiel,
	     ...
	     ITG *icyclic,double *c,ITG *ifatie,ITG *iau6,double *xxni,
	     double *xxnj,ITG *iturbulent,double *gradvel,double *of2,
	     double *yy,double *umel,ITG *ncfd,ITG *inlet,double *sc){
...
// next line! -> all parallel sections
    ...
    FORTRAN(mafillvcomp,(nef1,ipnei1,neifa1,neiel1,vfa1,xxn1,area1,
	    ...
	    xxni1,xxnj1,iturbulent1,gradvel1,of21,yy1,umel1,ncfd1,
	    inlet1,sc1));
