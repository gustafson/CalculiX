...
!     
     ...
     &             nboun_,nodeboun,ndirboun,xboun,iamboun,typeboun,
     &             ipompc,nodempc,coefmpc,nmpc,nmpc_,mpcfree,ikmpc,
     &             ilmpc,labmpc,nk,nk_,co,rig,nmethod,iperturb,ithermal,
     &             mi,nam,icomposite,ielmat,vold,orname,orab,norien,
     &             norien_,ielorien)
!     
            elseif((lakon(i)(1:1).eq.'B').or.
     &             (lakon(i)(1:1).eq.'T')) then
...
!     
     ...
     &         ialset,ikboun,ilboun,nboun,nboun_,nodeboun,ndirboun,
     &         xboun,iamboun,typeboun,mi,vold)
        endif
!     
