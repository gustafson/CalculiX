...
!     
      subroutine pt2_lim_calc (pt1,a2,a1,kappa,zeta,pt2_lim,iplausi)
!     
      implicit none
!     
      integer i,iplausi 
...
!     
!         if too many iterations are needed a default value is taken,    
!         which, however, is not correct, therefore iplausi=0.
!         This can happen if A2/A1 is so high that pt2 has to be
!         negative to get section 2 critical.
!     
          if(i.gt.25)then
