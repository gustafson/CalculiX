...
!
     ...
     &  nonei15(3,9),m,iflag,jj,indexc,islavsurf(2,*),
     &  indexcj,ifacew1(4,5),islavnode(*),nslavnode(*),ntie,
     &  nlayer,nopeexp,ifacew2(8,5),ifaceq(9,6),ifacet(7,4),
     &  nopespring,iface,nopespringj,ifacej,jfaces,n,ielemslave,
...
!
     ...
     &  aa(4,4),bb(4,6),pl(3,8),pslavsurf(3,*),
     &  cc(3,4),dd(3,6),c_limit(2,nfield),nodepos(4,2)
!
...
!     
         ...
         iface=islavsurf(1,kon(indexc+nopespring+2))
!     
...
!     
         do
            ...
            if(iface.ne.ifacej) exit
         enddo
         n=n-1
         jfaces=iface-10*int(iface/10.d0)
         indexe=ipkon(ielemslave)
!     
