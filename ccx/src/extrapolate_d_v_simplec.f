...
!
      subroutine extrapolate_d_v_simplec(nface,ielfa,xrlfa,adv,advfa,
...
c$omp&        volume,auv,ipnei)
c$omp& private(i,iel1,xl1,iel2,j,iel3,xl2,a1,a2,a3)
c$omp do
      do i=1,nface
         iel1=ielfa(1,i)
         xl1=xrlfa(1,i)
...
c            advfa(i)=volume(iel1)/adv(iel1)
!
            do j=1,3
               hfa(j,i)=vel(iel1,j)
            enddo
