...
/*	      nactdok[node]=1;*/
  ...
  if(*ithermal>1){
	 ...
	 column i */
	  ...
	  for(jj=0;jj<nope;++jj){
		  ...
		  if((jdof1!=0)&&(jdof2!=0)){
		      insert(ipointer,&mast1,&irowt,&jdof1,&jdof2,&ifree,&nzs_);
		  }
			 ...
			 idof2: nominal DOF of the SPC/MPC */
			  ...
			  if((id>0)&&(ikmpc[id-1]==idof2)){
				  ...
				  if(idof2!=0){
				      insert(ipointer,&mast1,&irowt,&idof1,&idof2,&ifree,&nzs_);
				  }
  ...
  for(i=0;i<*ne;++i){
	  ...
	  for(ll=jj;ll<3*nope;++ll){
	      ...
	      if((jdof1!=0)&&(jdof2!=0)){
		  insert(ipointer,&mast1,&irowv,&jdof1,&jdof2,&ifree,&nzs_);
	      }
	      else if((jdof1!=0)||(jdof2!=0)){
		  ...
		  if(*nmpc>0){
			  ...
			  while(1){
			      idof2=nactdoh[5*(nodempc[3*index-3]-1)+nodempc[3*index-2]];
			      if(idof2!=0){
				  insert(ipointer,&mast1,&irowv,&idof1,&idof2,&ifree,&nzs_);
			      }
			      index=nodempc[3*index-1];
			      if(index==0) break;
			  }
  ...
  */
  ...
  for(i=0;i<*ne;++i){
	  ...
	  for(ll=jj;ll<nope;++ll){
	      ...
	      if((jdof1!=0)&&(jdof2!=0)){
		  insert(ipointer,&mast1,&irowp,&jdof1,&jdof2,&ifree,&nzs_);
	      }
	      else if((jdof1!=0)||(jdof2!=0)){
		  ...
		  if(*nmpc>0){
			  ...
			  while(1){
			      ...
			      if(idof2!=0){
				  insert(ipointer,&mast1,&irowp,&idof1,&idof2,&ifree,&nzs_);
			      }
			      index=nodempc[3*index-1];
			      if(index==0) break;
			  }
  ...
  */
  ...
  if(*turbulent!=0){
	  ...
	  for(jj=0;jj<nope;++jj){
		  ...
		  if((jdof1!=0)&&(jdof2!=0)){
		      insert(ipointer,&mast1,&irowk,&jdof1,&jdof2,&ifree,&nzs_);
		  }
		  else if((jdof1!=0)||(jdof2!=0)){
			 ...
			 idof2: nominal DOF of the SPC/MPC */
			  ...
			  if((id>0)&&(ikmpc[id-1]==idof2)){
				  ...
				  if(idof2!=0){
				      insert(ipointer,&mast1,&irowk,&idof1,&idof2,&ifree,&nzs_);
				  }
				  index=nodempc[3*index-1];
				  if(index==0) break;
			      }
