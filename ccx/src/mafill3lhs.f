...
!
      subroutine mafill3lhs(co,nk,kon,ipkon,lakon,ne,nodeboun,ndirboun,
...
!
     ...
     &  indexe,nope,i0
!
      real*8 co(3,*),xboun(*),coefmpc(*),sm(60,60),adbv(*),aubv(*),
     &  var(*)
!
      real*8 value
!
...
!
        ...
        enddo
!
        call e_c3d_3lhs(co,nk,konl,lakon(i),sm,i,ipvar,var)
!
        do jj=1,3*nope
!
          j=(jj-1)/3+1
