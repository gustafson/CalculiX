...
!     
     ...
     &     ipoinpc(0:*),nef,nener,ier,mortar
!     
...
!     
     ...
     &         "*DYNAMIC%")
      ...
      enddo
!     
      if((iexpl.eq.0).and.(mortar.eq.-1)) then
        write(*,*) '*ERROR reading *DYNAMIC; massless contact is not'
        write(*,*) '       allowed in an implicit dynamic calculation' 
        ier=1
        return
      endif
!     
