...
!     
      subroutine umat_def_plas(elconloc,elas,emec,icmd,
     &     stre,xstate,iel,iint)
!     
...
!     
      integer cauchy
!     
      integer icmd,i,j,k,l,m,n,nt,kk(84),iel,iint
!     
      real*8 elconloc(*),elas(*),emec(*),s(6),al,ep(6),
     &     ee,un,s0,xn,stre(*),eq,c0,c1,c2,c3,dkl(3,3),ekl(3,3),
     &     q,dq,pp,el(6),xstate(*),um,c4
!     
...
!     
      xstate(1)=dsqrt(2.d0/3.d0*(ep(1)*ep(1)+ep(2)*ep(2)+
