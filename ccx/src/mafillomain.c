...
static double *au1,*ad1,*b1,*vfa1,*xxn1,*area1,*vel1,
    *umfa1,*alet1,*ale1,*gradtfa1,*xxi1,*body1,*volume1,*dtimef1,*velo1,
    *veloo1,*cvfa1,*hcfa1,*cvel1,*gradvel1,*xload1,*gamma1,*xrlfa1,
    *xxj1,*a11,*a21,*a31,*flux1,*xxni1,*xxnj1,*f11,*of21,*gradkel1,
    *gradoel1,*sc1;
...
/* subroutine for multithreading of mafillo */
...
// next line! -> all parallel sections
    ...
    FORTRAN(mafillo,(nef1,ipnei1,neifa1,neiel1,vfa1,xxn1,area1,
			 ...
			 b1,vel1,umfa1,alet1,ale1,gradtfa1,xxi1,
		     ...
		     iturbulent1,f11,of21,gradkel1,gradoel1,sc1));
